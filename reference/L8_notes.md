...
- Here's the prompt:
  ...
  ```
  Using the following figma mockup https://www.figma.com/design/b37Gdw0ambKq2isyUR6kCH/key-indicators?node-id=0-1&p=f&t=CU0XokgLseRxK1WL-0 use the Framelink Figma MCP server to analyze the mockup and build the underlying code in this next.js application. Use the recharts library for creating charts to make this a web application. Check how this application looks using the playwright MCP server and verify it looks as close to the mock as possible.
  ```   
